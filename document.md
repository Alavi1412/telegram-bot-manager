...
id  :  String  ,\
title : String ,\
input_message_content : [InputMessageContent](https://core.telegram.org/bots/api#inputmessagecontent) ,\
reply_markup : [InlineKeyboardMarkup](https://core.telegram.org/bots/api#inlinekeyboardmarkup) ,\
url : string ,\
hide_url : Boolean ,\
description : String ,\
...
Returns a page containing an embedded video player or a video file
...
Returns a voice recording in an .ogg container encoded with OPUS
...
Returns  a contact with a phone number
...
Returns  a link to a photo stored on the Telegram servers
...
Returns   a link to an animated GIF file stored on the Telegram servers
...
Returns a link to a video animation (H.264/MPEG-4 AVC video without sound) stored on the Telegram servers
...
Returns   a link to a sticker stored on the Telegram servers
...
Returns   a link to a file stored on the Telegram servers
...
Returns   a link to a video file stored on the Telegram servers
...
Returns   a link to a voice message stored on the Telegram servers
...
Returns   content of a text message to be sent as the result of an inline query
...
Returns    content of a location message to be sent as the result of an inline query.
...
Returns    content of a venue message to be sent as the result of an inline query.
...
Returns    content of a contact message to be sent as the result of an inline query.
...
result_id	 :  String ,\
from	  :  [User](https://core.telegram.org/bots/api#user) ,\
location : [Location](https://core.telegram.org/bots/api#location) ,\
inline_message_id : String ,\
query : String ,\


Returns    result of an inline query that was chosen by the user and sent to their chat partner.
